"""
Django settings for acts_open_house project.
Generated by 'django-admin startproject' using Django 1.8.7 of TLT template.
...
ROOT_URLCONF = 'acts_open_house.urls'
...
WSGI_APPLICATION = 'acts_open_house.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.normpath(os.path.join(BASE_DIR, 'acts_open_house.sqlite3'))
    },
}
...
CACHES = {
    'default': {
        ...
        'KEY_PREFIX': 'acts_open_house',  # Provide a unique value for shared cache
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'formatter': 'verbose',
            'filename': os.path.join(_LOG_ROOT, 'django-acts_open_house.log'),
        },
    },
